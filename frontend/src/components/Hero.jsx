          ...
          <div className="text-center max-w-5xl mx-auto">
            <div className="flex justify-center mb-8">
              <img 
                src={LOGO_URL} 
                alt="Gretta AI" 
                className="h-40 w-auto object-contain animate-float drop-shadow-2xl"
              />
            </div>

            <Badge className="mb-6 bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-300 text-blue-700 hover:bg-gradient-to-r hover:from-blue-200 hover:to-purple-200 shadow-sm">
              <Sparkles className="w-3 h-3 mr-2" />
              Powered by Advanced Voice AI
            </Badge>

            <h1 className="hero-headline text-5xl sm:text-6xl md:text-7xl font-bold text-slate-900 mb-6 leading-tight">
            ...
            <div className="flex flex-col items-center space-y-6 mb-12">
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:opacity-90 text-white font-semibold px-8 py-6 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-blue-500 text-blue-600 hover:bg-blue-500 hover:text-white font-semibold px-8 py-6 text-lg transition-all duration-300 hover:scale-105 shadow-lg"
                  onClick={() => {
              ...
              <div className="phone-number-display bg-white border-2 border-blue-300 rounded-2xl px-8 py-6 hover:border-purple-400 transition-all duration-300 hover:scale-105 cursor-pointer group shadow-xl hover:shadow-2xl">
                <a href={telLink} className="block">
                  ...
                  <p className="text-4xl sm:text-5xl font-bold text-slate-900 group-hover:text-gradient group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 group-hover:bg-clip-text group-hover:text-transparent transition-all">
                    {phoneNumber}
                  </p>
                </a>
              </div>
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 text-slate-700">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm sm:text-base font-medium">Inbound Calls</span>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm sm:text-base font-medium">Smart Booking</span>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm sm:text-base font-medium">SMS Automation</span>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm sm:text-base font-medium">Outbound Reach</span>
              </div>
            </div>
          </div>
        </div>
